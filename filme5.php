...
<?php include_once './views/includes/header.php' ?>
    ...
    <section class="banner">
        <img src="https://i.ibb.co/fFNxfZS/ce50439bddf3.jpg" alt="Storm">
        <div class="banner-content">
            <h1>Vingadores</h1>
            <p>Drama|Aventura | 2012 | 2h 23min</p>
       ...
       <!--<button id="myBtn">Open Modal</button>-->
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <iframe width="100%" height="510" src="https://www.youtube.com/embed/KeNEGtsCWEk?si=Quio2xVE4gjiqTLk"
