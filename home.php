...
<div class="container">
    <div class="content-container">
        <div class="featured-content" style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('https://i.ibb.co/6nwr2Bz/e31f7ffe161a.jpg');">
            <img class="featured-title" src="https://i.ibb.co/fDWt6N1/72c95324aa11.png" alt="">
            <p class="featured-desc">
                Situado num contexto pré-Guerra de Secessão do Deep South e Velho Oeste, o filme acompanha Django,
                um escravo liberto que caminha pelos Estados Unidos com um caçador de recompensas em uma missão para
                resgatar sua esposa de um fazendeiro cruel.
            </p>
            <a href="./filme_destaque1.php">
                        ...
                        <div class="movie-list">
                            ...
                            ?>
                                    <div class="movie-list-item">
                                        ...
                                        <p class="movie-list-item-desc"><?= htmlspecialchars($filme['mini_sinopse']); ?></p>
